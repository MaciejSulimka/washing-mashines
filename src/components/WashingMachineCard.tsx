        ...
        <div className="washingMachineCard">
            ...
            <div className="washingMachineCard__details">
                ...
                <div className="washingMachineCard__payment">
                    ...
                    <div className="washingMachineCard__payment-priceWrapper">
                        <h4 className="washingMachineCard__payment-amount">{amount}</h4>
                        <div className="washingMachineCard__payment-restWrapper">
                            <h4 className="washingMachineCard__payment-rest">{rest}</h4>
                            <p className="washingMachineCard__payment-currency">zł</p>
                        </div>
                    </div>
                    <p className="washingMachineCard__payment-installment">{device.monthlyInstallment} x {device.numberOfInstallments} rat</p>
                </div>
            </div>
            <button className={`washingMachineCard__button ${isSelected ? 'selected' : ''}`} onClick={handleTogglle}>{isSelected ? 'Wybrane' : 'Wybierz'}</button>
        </div>
    )
